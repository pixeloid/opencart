...
# Database: koromproblemak
# Generation Time: 2015-02-22 18:48:50 +0000
# ************************************************************
...
INSERT INTO `api` (`api_id`, `username`, `firstname`, `lastname`, `password`, `status`, `date_added`, `date_modified`)
VALUES
	(1,'hyGctNcWPqyM83Uobe93TIZllqCuOghwVnOF1rbHYPUWJoAlJAfcJ5EulGf0nCm8','','','',1,'2015-02-22 19:31:54','2015-02-22 19:31:54');
...
INSERT INTO `banner_image` (`banner_image_id`, `banner_id`, `link`, `image`, `sort_order`)
VALUES
...
VALUES
	(33,'',0,1,1,6,1,'2009-02-03 14:17:55','2015-02-22 19:44:26');
...
VALUES
	(33,2,'MC 2000 Körömápolás','&lt;p&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;br&gt;&lt;/p&gt;','MC 2000 Körömápolás','',''),
	(33,1,'MC 2000 Körömápolás','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','MC 2000 Körömápolás','','');
...
VALUES
	(1,'Pound Sterling','GBP','£','','2',0.64950001,1,'2015-02-22 19:32:33'),
	(2,'US Dollar','USD','$','','2',1.00000000,1,'2015-02-22 19:44:35'),
	(3,'Euro','EUR','','€','2',0.87840003,1,'2015-02-22 19:32:33');
...
VALUES
	(2,'Magyar','hu','hu_HU.UTF-8,hu_HU,hu-hu,hungarian','hu.png','hungarian',1,1);
...
INSERT INTO `product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`)
VALUES
	...
	(50,'Cuticle Care Pen','','','','','','','',1,0,'catalog/Termekek/IMG_6440b.jpg',0,1,0.0000,0,0,'2015-02-22',0.00000000,0,0.00000000,0.00000000,0.00000000,0,1,1,1,1,0,'2015-02-22 19:46:45','2015-02-22 19:47:01');
...
INSERT INTO `product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`)
VALUES
	(35,1,'Product 8','&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n','','','',''),
	...
	(50,2,'Cuticle Care Pen','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','','Cuticle Care Pen','','');
...
VALUES
	...
	(188,0,'config','config_language','hu',0),
	(189,0,'config','config_admin_language','hu',0),
	...
	(280,0,'config','config_email','info@pixeloid.hu',0),
	...
	(282,0,'config','config_encryption','71b4994f7a491248269b327da115916d',0),
	...
	(281,0,'config','config_url','http://localhost:8000/',0);
...
VALUES
	(1,1,'admin','43e978d43ca96b1be74a3daa8558dbffa57774bb','d3527b1a1','John','Doe','info@pixeloid.hu','','','::1',1,'2015-02-22 19:31:54');
